...
public class CheckPath {
	public static ArrayList<Tile> generatePath(ArrayList<Tile> all_tiles){
		...
		while(!(path.get(path.size()-1) instanceof End)) {
				...
				if(i>=4 && all_tiles.get(i).getProperty().equals("Vertical") && 
				   all_tiles.get(i-4).getProperty().equals("Vertical") && 
				   !isInList(path, all_tiles.get(i-4))){
					path.add(all_tiles.get(i-4));
					i-=4;
				}
				else if(i<12 && all_tiles.get(i).getProperty().equals("Vertical") && 
					all_tiles.get(i+4).getProperty().equals("Vertical") && 
					!isInList(path, all_tiles.get(i+4))){
				...
				else if(i>=4 && all_tiles.get(i).getProperty().equals("Vertical") && 
				...
				else if(i>=4 && (all_tiles.get(i).getProperty().equals("00")) && 
					all_tiles.get(i-4).getProperty().equals("Vertical") && 
					!isInList(path, all_tiles.get(i-4))) {
					path.add(all_tiles.get(i-4));
					i-=4;
				}
				else if(i>=1 && (all_tiles.get(i).getProperty().equals("00")) && 
					all_tiles.get(i-1).getProperty().equals("Horizontal") && 
					!isInList(path, all_tiles.get(i-1))) {
				...
				else if(i>=4 && (all_tiles.get(i).getProperty().equals("01")) && 
					all_tiles.get(i-4).getProperty().equals("Vertical") && 
					!isInList(path, all_tiles.get(i-4))) {
					path.add(all_tiles.get(i-4));
					i-=4;
				...
				else if(i<15 && (all_tiles.get(i).getProperty().equals("01")) && 
				...
				else if(i<12 && (all_tiles.get(i).getProperty().equals("10")) && 
					all_tiles.get(i+4).getProperty().equals("Vertical") && 
					!isInList(path, all_tiles.get(i+4))) {
					path.add(all_tiles.get(i+4));
					i+=4;
				}
				else if(i>1 && (all_tiles.get(i).getProperty().equals("10")) && 
				...
				else if(i<12 && (all_tiles.get(i).getProperty().equals("11")) && 
					all_tiles.get(i+4).getProperty().equals("Vertical") && 
					!isInList(path, all_tiles.get(i+4))) {
					path.add(all_tiles.get(i+4));
					i+=4;
				}
				else if(i<15 && (all_tiles.get(i).getProperty().equals("11")) && 
						all_tiles.get(i+1).getProperty().equals("10") && 
						!isInList(path, all_tiles.get(i+1))) {
						path.add(all_tiles.get(i+1));
						i+=1;
				...
				else if(i>=1 && (all_tiles.get(i).getProperty().equals("Horizontal")) && 
						all_tiles.get(i-1).getProperty().equals("Horizontal")  && 
						   !isInList(path, all_tiles.get(i-1))) {
						path.add(all_tiles.get(i-1));
						i-=1;
				}
				else if(i<15 && (all_tiles.get(i).getProperty().equals("Horizontal")) && 
						all_tiles.get(i+1).getProperty().equals("Horizontal") && 
						   !isInList(path, all_tiles.get(i+1))) {
						path.add(all_tiles.get(i+1));
						i+=1;
